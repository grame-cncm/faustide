...
type ExampleLoaderControllerOptions = {
...
/**
 * Loads the static Faust examples index and imports selected examples.
 *
 * The controller owns the examples dropdown DOM, `examples.json` loading, and
 * selected-file import flow. It delegates project mutation to FileManager and
 * uses injected compile callbacks to preserve realtime recompilation behavior.
 */
export class ExampleLoaderController {
    ...
    constructor(options: ExampleLoaderControllerOptions) {
